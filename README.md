...
1.  **Сбор данных (n8n):** Воркфлоу параллельно опрашивает разные модели, собирает результаты в CSV и защищен от API-лимитов (Too Many Requests) с помощью системы Batching (очередей) и Throttling (задержек).
